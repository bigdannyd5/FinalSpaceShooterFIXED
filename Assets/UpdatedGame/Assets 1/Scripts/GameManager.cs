...
public class GameManager : MonoBehaviour 
{
	...
	void UpdateGameManagerState()
	{
		...
		case GameManagerState.EndLevel:
                ...
                //if (UserC.GetComponent<CurrentUser>().currentUser.getHighScore() < scoreUITextGO.GetComponent<GameScore>().Score)
                //

                //    UserC.GetComponent<CurrentUser>().currentUser.setHighScore(scoreUITextGO.GetComponent<GameScore>().Score);
                //    UserC.GetComponent<CurrentUser>().Save(UserC.GetComponent<CurrentUser>().currentUser);
                //
                //                }
